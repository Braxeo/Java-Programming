package com.example.braxeo.masterflow;
...
import com.example.braxeo.masterflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((WebView) rootView.findViewById(R.id.detail_page)).loadUrl(mItem.url);
        }
